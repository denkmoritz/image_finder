...
def _local_path(dest_name: str) -> Path:
    """Save as images/{uuid}.jpg"""
    return IMAGES_DIR / f"{dest_name}.jpg"
...
def download_pairs(pairs: Iterable[Tuple[str, str]]) -> Dict:
    """
    pairs: (fetch_id -> Mapillary image id, dest_name -> UUID)
    Downloads original (thumb_original_url) and saves as images/{uuid}.jpg
